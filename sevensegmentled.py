...
p1NumSegPins = [17,5,19,20,22,13,6]    #aka red team
...
numShapeValues.append([1,1,1,1,0,1,0]) #1
numShapeValues.append([0,0,0,1,0,0,1]) #2
numShapeValues.append([0,0,0,1,0,1,0]) #3
numShapeValues.append([1,0,1,0,0,1,0]) #4
numShapeValues.append([0,0,0,0,1,1,0]) #5
numShapeValues.append([0,0,0,0,1,0,0]) #6
numShapeValues.append([0,1,1,1,0,1,0]) #7
numShapeValues.append([0,0,0,0,0,0,0]) #8
numShapeValues.append([0,0,0,0,0,1,0]) #9
